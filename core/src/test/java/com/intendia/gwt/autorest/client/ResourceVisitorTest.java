...
public class ResourceVisitorTest {
    ...
    @Test public void collector_visitor_works() {
        ...
        final ResourceVisitor.Supplier ch1 = new ResourceVisitor.Supplier() {
            public ResourceVisitor get() { return ch0.get().path("path1").param("p1", "v1", new TypeToken<String>(String.class) {}); }
        };
        ...
        ResourceVisitor.Supplier ch2 = new ResourceVisitor.Supplier() {
            public ResourceVisitor get() { return ch1.get().path("path2").param("p2", asList("v2a", "v2b"), new TypeToken<List<String>>(List.class, new TypeToken<String>(String.class) {}) {}); }
        };
    ...
    private static class MyCollectorResourceVisitor extends CollectorResourceVisitor {
        ...
        @Override public <T> T as(TypeToken<T> typeToken) { return null; }
    }
}
