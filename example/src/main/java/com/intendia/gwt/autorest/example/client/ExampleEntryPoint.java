...
public class ExampleEntryPoint implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        ResourceVisitor.Supplier getApi = () -> new RequestResourceBuilder()
                .dispatcher(rb -> {
                    Label info = new Label(rb.getUrl() + " (PENDING)");
                    status.add(info);
                    ...
                    rb.setCallback(new RequestCallback() {
                        ...
                        public void onResponseReceived(Request request, Response response) {
                            info.setText(rb.getUrl() + " (RECEIVED)");
                            hide.run();
                        ...
                        public void onError(Request request, Throwable exception) {
                            info.setText(rb.getUrl() + "(ERROR): " + exception);
                            hide.run();
        ...
        sService.getJackson().subscribe(greeting -> {
            Window.alert(greeting.toString());
        });
    }
